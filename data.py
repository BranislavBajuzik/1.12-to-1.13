...
Globals.selectorArgsNew = (("x", "x", "x"), ("y", "y", "y"), ("z", "z", "z"), ("dx", "dx", "dx"), ("dy", "dy", "dy"), ("dz", "dz", "dz"), ("type", "type", "type"), ("level", "lm", "l"), ("gamemode", "m", "m"), ("team", "team", "team"), ("scores", "score", "score"), ("name", "name", "name"), ("tag", "tag", "tag"), ("distance", "rm", "r"), ("x_rotation", "rxm", "rx"), ("y_rotation", "rym", "ry"), ("limit", "c", "c"), ("limit", "limit", "limit"), ("sort", "sort", "sort"), ("advancements", "advancements", "advancements"), ("nbt", "nbt", "nbt"))
...
Globals.selectorRe = re.compile(r"^(?:@[parse](?:\[(?:[a-zA-Z0-9_]+=(?:!?[a-zA-Z0-9_:/-]*)?(?:,[a-zA-Z0-9_]+=(?:!?[a-zA-Z0-9_:/-]*)?)*)?])?|[^@=\[\]*]+)$")
