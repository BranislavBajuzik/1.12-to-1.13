...
Globals.blockDefaults = {
    ...
    "dirt": ("dirt[snowy=false]", None),
    "cobblestone": ("cobblestone", None),
    "planks": ("oak_planks", None),
    "sapling": ("oak_sapling[stage=0]", None),
    "bedrock": ("bedrock", None),
    "flowing_water": ("flowing_water[level=0]", None),
    "water": ("water[level=0]", None),
    "flowing_lava": ("flowing_lava[level=0]", None),
    "lava": ("lava[level=0]", None),
    "sand": ("sand", None),
    "gravel": ("gravel", None),
    "gold_ore": ("gold_ore", None),
    "iron_ore": ("iron_ore", None),
    "coal_ore": ("coal_ore", None),
    "log": ("oak_log[axis=y]", None),
    "leaves": ("oak_leaves[check_decay=true,decayable=true]", None),
    "sponge": ("sponge", None),
    "glass": ("glass", None),
    "lapis_ore": ("lapis_ore", None),
    "lapis_block": ("lapis_block", None),
    "dispenser": ("dispenser[facing=north,triggered=false]", None),
    "sandstone": ("sandstone", None),
    "noteblock": ("note_block", {"note": "0b", "powered": "0b"}),
    "bed": ("red_bed[facing=north,occupied=false,part=foot]", {"color": "0"}),
    "golden_rail": ("powered_rail[powered=false,shape=north_south]", None),
    "detector_rail": ("detector_rail[shape=north_south]", None),
    "sticky_piston": ("sticky_piston[extended=false,facing=north]", None),
    "web": ("cobweb", None),
    "tallgrass": ("dead_bush", None),
    "deadbush": ("dead_bush", None),
    "piston": ("piston[extended=false,facing=north]", None),
    "piston_head": ("piston_head[facing=north,short=false,type=normal]", None),
    "wool": ("white_wool", None),
    "piston_extension": ("moving_piston[facing=north,type=normal]", None),
    ...
    "double_stone_slab": ("stone_slab[type=double]", None),
    "stone_slab": ("stone_slab[type=bottom]", None),
    ...
    "torch": ("torch", None),
    "fire": ("fire[age=0,up=false,north=false,east=false,west=false,south=false]", None),
    "mob_spawner": ("mob_spawner", None),
    "oak_stairs": ("oak_stairs[facing=north,half=bottom,shape=straight]", None),
    "chest": ("chest[facing=north]", None),
    ...
    "wheat": ("wheat[age=0]", None),
    "farmland": ("farmland[moisture=0]", None),
    "furnace": ("furnace[facing=north]", None),
    "lit_furnace": ("furnace[facing=north,lit=true]", None),
    "standing_sign": ("sign[rotation=0]", None),
    "wooden_door": ("oak_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "ladder": ("ladder[facing=north]", None),
    "rail": ("rail[north_south]", None),
    "stone_stairs": ("cobblestone_stairs[facing=north,half=bottom,shape=straight]", None),
    "wall_sign": ("wall_sign[facing=north]", None),
    "lever": ("lever[face=wall,facing=north,powered=false]", None),
    "stone_pressure_plate": ("stone_pressure_plate[powered=false]", None),
    "iron_door": ("iron_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "wooden_pressure_plate": ("oak_pressure_plate[powered=false]", None),
    "lit_redstone_ore": ("redstone_ore[lit=true]", None),
    "redstone_ore": ("redstone_ore", None),
    "unlit_redstone_torch": ("redstone_torch[lit=false]", None),
    "redstone_torch": ("redstone_torch", None),
    "stone_button": ("stone_button[face=wall,facing=north,powered=false]", None),
    "snow_layer": ("snow[layers=1]", None),
    "ice": ("ice", None),
    "snow": ("snow_block", None),
    "cactus": ("cactus[age=0]", None),
    "clay": ("clay", None),
    "reeds": ("sugar_cane[age=0]", None),
    "jukebox": ("jukebox[has_record=false]", None),
    "fence": ("oak_fence", None),
    "pumpkin": ("carved_pumpkin[facing=north]", None),
    "netherrack": ("netherrack", None),
    "soul_sand": ("soul_sand", None),
    "glowstone": ("glowstone", None),
    "portal": ("portal[axis=x]", None),
    "lit_pumpkin": ("jack_o_lantern[facing=north]", None),
    "cake": ("cake[bites=0]", None),
    "unpowered_repeater": ("repeater[delay=1,facing=north,locked=false]", None),
    "powered_repeater": ("repeater[powered=true,delay=1,facing=north,locked=false]", None),
    "stained_glass": ("white_stained_glass", None),
    "trapdoor": ("oak_trapdoor[facing=north,half=bottom,open=false]", None),
    "monster_egg": ("infested_stone", None),
    "stonebrick": ("stone_bricks", None),
    "brown_mushroom_block": ("brown_mushroom_block[down=true,east=true,north=true,south=true,up=true,west=true]", None),
    "red_mushroom_block": ("red_mushroom_block[down=true,east=true,north=true,south=true,up=true,west=true]", None),
    "iron_bars": ("iron_bars", None),
    "glass_pane": ("glass_pane", None),
    "melon_block": ("melon_block", None),
    "pumpkin_stem": ("pumpkin_stem[age=0,facing=up]", None),
    "melon_stem": ("melon_stem[age=0,facing=up]", None),
    "vine": ("vine[east=false,north=false,south=false,up=false,west=false]", None),
    "fence_gate": ("oak_fence_gate[facing=north,in_wall=false,open=false,powered=false]", None),
    "brick_stairs": ("brick_stairs[facing=north,half=bottom,shape=straight]", None),
    "stone_brick_stairs": ("stone_brick_stairs[facing=north,half=bottom,shape=straight]", None),
    "mycelium": ("mycelium", None),
    "waterlily": ("lily_pad", None),
    "nether_brick": ("nether_brick", None),
    "nether_brick_fence": ("nether_brick_fence", None),
    "nether_brick_stairs": ("nether_brick_stairs[facing=north,half=bottom,shape=straight]", None),
    "nether_wart": ("nether_wart[age=0]", None),
    "enchanting_table": ("enchanting_table", None),
    "brewing_stand": ("brewing_stand", None),
    "cauldron": ("cauldron[level=0]", None),
    "end_portal": ("end_portal", None),
    "end_portal_frame": ("end_portal_frame[eye=false,facing=north]", None),
    "end_stone": ("end_stone", None),
    "dragon_egg": ("dragon_egg", None),
    "redstone_lamp": ("redstone_lamp", None),
    "lit_redstone_lamp": ("redstone_lamp[lit=true]", None),
    "double_wooden_slab": ("oak_slab[type=double]", None),
    "wooden_slab": ("oak_slab[half=bottom]", None),
    "cocoa": ("cocoa[age=0,facing=north]", None),
    "sandstone_stairs": ("sandstone_stairs[facing=north,half=bottom,shape=straight]", None),
    "emerald_ore": ("emerald_ore", None),
    "ender_chest": ("ender_chest[facing=north]", None),
    "tripwire_hook": ("tripwire_hook[attached=false,facing=north,powered=false]", None),
    "tripwire": ("tripwire[attached=false,disarmed=false,powered=false]", None),
    "emerald_block": ("emerald_block", None),
    "spruce_stairs": ("spruce_stairs[facing=north,half=bottom,shape=straight]", None),
    "birch_stairs": ("birch_stairs[facing=north,half=bottom,shape=straight]", None),
    "jungle_stairs": ("jungle_stairs[facing=north,half=bottom,shape=straight]", None),
    "command_block": ("command_block[conditional=false,facing=north]", None),
    "beacon": ("beacon", None),
    "cobblestone_wall": ("cobblestone_wall", None),
    "flower_pot": ("flower_pot", None),
    "carrots": ("carrots[age=0]", None),
    "potatoes": ("potatoes=[age=0]", None),
    "wooden_button": ("oak_button[face=wall,facing=north,powered=false]", None),
    "skull": ("skeleton_wall_skull", {"Rot": "0b", "SkullType": "0b"}),
    "anvil": ("anvil[facing=north,damage=1]", None),
    "trapped_chest": ("trapped_chest[facing=north]", None),
    "light_weighted_pressure_plate": ("light_weighted_pressure_plate[power=0]", None),
    "heavy_weighted_pressure_plate": ("heavy_weighted_pressure_plate[power=0]", None),
    "unpowered_comparator": ("comparator[facing=north,mode=compare,powered=false]", None),
    "powered_comparator": ("comparator[facing=south,mode=compare,powered=false]", None),
    "daylight_detector": ("daylight_detector[power=0]", None),
    "redstone_block": ("redstone_block", None),
    "quartz_ore": ("nether_quartz_ore", None),
    "hopper": ("hopper[enabled=true,facing=down]", None),
    "quartz_block": ("quartz_block", None),
    "quartz_stairs": ("quartz_stairs[facing=north,half=bottom,shape=straight]", None),
    "activator_rail": ("activator_rail[shape=north_south]", None),
    "dropper": ("dropper[facing=north,triggered=false]", None),
    "stained_hardened_clay": ("white_terracotta", None),
    "stained_glass_pane": ("white_stained_glass_pane", None),
    "leaves2": ("acacia_leaves[check_decay=true,decayable=true]", None),
    "log2": ("acacia_log[axis=y]", None),
    "acacia_stairs": ("acacia_stairs[facing=north,half=bottom,shape=straight]", None),
    "dark_oak_stairs": ("dark_oak_stairs[facing=north,half=bottom,shape=straight]", None),
    "slime": ("slime_block", None),
    "barrier": ("barrier", None),
    "iron_trapdoor": ("iron_trapdoor[facing=north,half=bottom,open=false]", None),
    "prismarine": ("prismarine", None),
    "sea_lantern": ("sea_lantern", None),
    "hay_block": ("hay_block[axis=y]", None),
    "carpet": ("white_carpet", None),
    "hardened_clay": ("terracotta", None),
    "coal_block": ("coal_block", None),
    "packed_ice": ("packed_ice", None),
    "double_plant": ("sunflower[half=lower]", None),
    "standing_banner": ("black_banner[rotation=0]", {"Base": "0"}),
    "wall_banner": ("black_wall_banner[rotation=0]", {"Base": "0"}),
    "daylight_detector_inverted": ("daylight_detector[inverted=true,power=0]", None),
    "red_sandstone": ("red_sandstone", None),
    "red_sandstone_stairs": ("red_sandstone_stairs[facing=north,half=bottom,shape=straight]", None),
    "double_stone_slab2": ("red_sandstone_slab[type=double]", None),
    "stone_slab2": ("red_sandstone_slab[type=bottom]", None),
    "spruce_fence_gate": ("spruce_fence_gate[facing=north,in_wall=false,open=false,powered=false]", None),
    "birch_fence_gate": ("birch_fence_gate[facing=north,in_wall=false,open=false,powered=false]", None),
    "jungle_fence_gate": ("jungle_fence_gate[facing=north,in_wall=false,open=false,powered=false]", None),
    "dark_oak_fence_gate": ("dark_oak_fence_gate[facing=north,in_wall=false,open=false,powered=false]", None),
    "acacia_fence_gate": ("acacia_fence_gate[facing=north,in_wall=false,open=false,powered=false]", None),
    ...
    "spruce_door": ("spruce_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "birch_door": ("birch_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "jungle_door": ("jungle_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "acacia_door": ("acacia_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "dark_oak_door": ("dark_oak_door[facing=north,half=lower,hinge=left,open=false,powered=false]", None),
    "end_rod": ("end_rod[facing=up]", None),
    "chorus_plant": ("chorus_plant", None),
    "chorus_flower": ("chorus_flower[age=0]", None),
    "purpur_block": ("purpur_block", None),
    "purpur_pillar": ("purpur_pillar[axis=y]", None),
    "purpur_stairs": ("purpur_stairs[facing=north,half=bottom,shape=straight]", None),
    "purpur_double_slab": ("purpur_slab[type=double]", None),
    "purpur_slab": ("purpur_slab[type=bottom]", None),
    "end_bricks": ("end_stone_bricks", None),
    "beetroots": ("beetroots[age=0]", None),
    "grass_path": ("grass_path", None),
    "end_gateway": ("end_gateway", None),
    "repeating_command_block": ("repeating_command_block[conditional=false,facing=north]", None),
    "chain_command_block": ("chain_command_block[conditional=false,facing=north]", None),
    "frosted_ice": ("frosted_ice[age=0]", None),
    "magma": ("magma_block", None),
    "nether_wart_block": ("nether_wart_block", None),
    "red_nether_brick": ("red_nether_bricks", None),
    "bone_block": ("bone_block[axis=y]", None),
    "structure_void": ("structure_void", None),
    "observer": ("observer[powered=false,facing=north]", None),
    "white_shulker_box": ("white_shulker_box[facing=north]", None),
    "orange_shulker_box": ("orange_shulker_box[facing=north]", None),
    "magenta_shulker_box": ("magenta_shulker_box[facing=north]", None),
    "light_blue_shulker_box": ("light_blue_shulker_box[facing=north]", None),
    "yellow_shulker_box": ("yellow_shulker_box[facing=north]", None),
    "lime_shulker_box": ("lime_shulker_box[facing=north]", None),
    "pink_shulker_box": ("pink_shulker_box[facing=north]", None),
    "gray_shulker_box": ("gray_shulker_box[facing=north]", None),
    "silver_shulker_box": ("silver_shulker_box[facing=north]", None),
    "cyan_shulker_box": ("cyan_shulker_box[facing=north]", None),
    "purple_shulker_box": ("purple_shulker_box[facing=north]", None),
    "blue_shulker_box": ("blue_shulker_box[facing=north]", None),
    "brown_shulker_box": ("brown_shulker_box[facing=north]", None),
    "green_shulker_box": ("green_shulker_box[facing=north]", None),
    "red_shulker_box": ("red_shulker_box[facing=north]", None),
    "black_shulker_box": ("black_shulker_box[facing=north]", None),
    "white_glazed_terracotta": ("white_glazed_terracotta[facing=north]", None),
    "orange_glazed_terracotta": ("orange_glazed_terracotta[facing=north]", None),
    "magenta_glazed_terracotta": ("magenta_glazed_terracotta[facing=north]", None),
    "light_blue_glazed_terracotta": ("light_blue_glazed_terracotta[facing=north]", None),
    "yellow_glazed_terracotta": ("yellow_glazed_terracotta[facing=north]", None),
    "lime_glazed_terracotta": ("lime_glazed_terracotta[facing=north]", None),
    "pink_glazed_terracotta": ("pink_glazed_terracotta[facing=north]", None),
    "gray_glazed_terracotta": ("gray_glazed_terracotta[facing=north]", None),
    "silver_glazed_terracotta": ("silver_glazed_terracotta[facing=north]", None),
    "cyan_glazed_terracotta": ("cyan_glazed_terracotta[facing=north]", None),
    "purple_glazed_terracotta": ("purple_glazed_terracotta[facing=north]", None),
    "blue_glazed_terracotta": ("blue_glazed_terracotta[facing=north]", None),
    "brown_glazed_terracotta": ("brown_glazed_terracotta[facing=north]", None),
    "green_glazed_terracotta": ("green_glazed_terracotta[facing=north]", None),
    "red_glazed_terracotta": ("red_glazed_terracotta[facing=north]", None),
    "black_glazed_terracotta": ("black_glazed_terracotta[facing=north]", None),
    "concrete": ("white_concrete", None),
    "concrete_powder": ("white_concrete_powder", None),
    "structure_block": ("structure_block", None),
}
entityCriteria = ("Bat", "Blaze", "CaveSpider", "Chicken", "Cow", "Creeper", "Donkey", "ElderGuardian", "Enderman", "Endermite", "EvocationIllager", "Ghast", "Guardian", "Horse", "Husk", "LavaSlime", "Llama", "Mule", "MushroomCow", "Ozelot", "Parrot", "Pig", "PigZombie", "PolarBear", "Rabbit", "Sheep", "Shulker", "Silverfish", "Skeleton", "SkeletonHorse", "Slime", "Spider", "Squid", "Stray", "Vex", "Villager", "VindicationIllager", "Witch", "WitherSkeleton", "Wolf", "Zombie", "ZombieHorse", "ZombieVillager")
