...
class Selector(TestBase):
    ...
    def test_syntax_convert(self):
        argPairs = [(("x=1", "x=1"), ("x=-1", "x=-1")),
                    ...
                    (("dy=1", "dy=1"), ),
                    (("dz=1", "dz=1"), ),
                    (("type=Cow", "type=cow"), ("type=!cow", "type=!cow"), ("type=minecraft:Cow", "type=cow"), ("type=!minecraft:cow", "type=!cow")),
...
class Scoreboard(TestBase):
    ...
    def test_syntax17_convert(self):
        tests = (("scoreboard teams option aTeam color reset", "team modify aTeam color reset"),
                 ("scoreboard teams option aTeam color aqua", "team modify aTeam color aqua"),
                 ("scoreboard teams option aTeam color black", "team modify aTeam color black"),
                 ("scoreboard teams option aTeam color blue", "team modify aTeam color blue"),
                 ("scoreboard teams option aTeam color dark_aqua", "team modify aTeam color dark_aqua"),
                 ("scoreboard teams option aTeam color dark_blue", "team modify aTeam color dark_blue"),
                 ("scoreboard teams option aTeam color dark_gray", "team modify aTeam color dark_gray"),
                 ("scoreboard teams option aTeam color dark_green", "team modify aTeam color dark_green"),
                 ("scoreboard teams option aTeam color dark_purple", "team modify aTeam color dark_purple"),
                 ("scoreboard teams option aTeam color dark_red", "team modify aTeam color dark_red"),
                 ("scoreboard teams option aTeam color gold", "team modify aTeam color gold"),
                 ("scoreboard teams option aTeam color gray", "team modify aTeam color gray"),
                 ("scoreboard teams option aTeam color green", "team modify aTeam color green"),
                 ("scoreboard teams option aTeam color light_purple", "team modify aTeam color light_purple"),
                 ("scoreboard teams option aTeam color red", "team modify aTeam color red"),
                 ("scoreboard teams option aTeam color white", "team modify aTeam color white"),
                 ("scoreboard teams option aTeam color yellow", "team modify aTeam color yellow"),
                 ("scoreboard teams option aTeam friendlyfire true", "team modify aTeam friendlyfire true"),
                 ("scoreboard teams option aTeam friendlyfire false", "team modify aTeam friendlyfire false"),
                 ("scoreboard teams option aTeam seeFriendlyInvisibles true", "team modify aTeam seeFriendlyInvisibles true"),
                 ("scoreboard teams option aTeam seeFriendlyInvisibles false", "team modify aTeam seeFriendlyInvisibles false"),
                 ("scoreboard teams option aTeam nametagVisibility never", "team modify aTeam nametagVisibility never"),
                 ("scoreboard teams option aTeam nametagVisibility hideForOtherTeams", "team modify aTeam nametagVisibility hideForOtherTeams"),
                 ("scoreboard teams option aTeam nametagVisibility hideForOwnTeam", "team modify aTeam nametagVisibility hideForOwnTeam"),
                 ("scoreboard teams option aTeam nametagVisibility always", "team modify aTeam nametagVisibility always"),
                 ("scoreboard teams option aTeam deathMessageVisibility never", "team modify aTeam deathMessageVisibility never"),
                 ("scoreboard teams option aTeam deathMessageVisibility hideForOtherTeams", "team modify aTeam deathMessageVisibility hideForOtherTeams"),
                 ("scoreboard teams option aTeam deathMessageVisibility hideForOwnTeam", "team modify aTeam deathMessageVisibility hideForOwnTeam"),
                 ("scoreboard teams option aTeam deathMessageVisibility always", "team modify aTeam deathMessageVisibility always"),
                 ("scoreboard teams option aTeam collisionRule always", "team modify aTeam collisionRule always"),
                 ("scoreboard teams option aTeam collisionRule never", "team modify aTeam collisionRule never"),
                 ("scoreboard teams option aTeam collisionRule pushOwnTeam", "team modify aTeam collisionRule pushOwnTeam"),
                 ("scoreboard teams option aTeam collisionRule pushOtherTeams", "team modify aTeam collisionRule pushOtherTeams"))
        for before, after in tests:
            self.assertEqual(after, unicode(converter.decide(before)), "source: \'{}\'".format(before))
        self.assertStats()
